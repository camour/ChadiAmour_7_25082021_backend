...
exports.selectArticles = () => {
    ...
    let selectQuery = 'SELECT Articles.id AS articleId, Articles.subject AS articleSubject, LOWER(Articles.content) AS articleContent, Articles.publishingDate AS articlePublishingDate, User.userName AS articleUserName FROM Articles INNER JOIN User ON Articles.userId = User.id';
